...
describe("Decoder lifecycle", function () {
    it("spawns a decoder instance", function () {
        var spy = jest.fn();
        var decoder = new _1.default(Buffer.from("hello world"), spy, false);
        expect(spy).toHaveBeenCalledTimes(1);
        expect(spy).toHaveBeenCalledWith(new Error(_1.DECODER_ERRORS.WRONG_MESSAGE_FORMAT), decoder);
    ...
    it("decodes hello world json message", function () {
        var spy = jest.fn();
        var decoder = new _1.default(Buffer.from(HELLO_WORLD, 'base64'), spy, false);
        expect(spy).toHaveBeenCalledTimes(1);
    ...
    it("decodes hello world json gzipped message", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    spy = jest.fn();
                    decoder = new _1.default(Buffer.from(GZIP_HELLO_WORLD, 'base64'), spy, false);
                    return [4, sleep(1000)];
                case 1:
                    _a.sent();
                    expect(spy).toHaveBeenCalledTimes(1);
    ...
    it("decodes hello world json deflated message", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    spy = jest.fn();
                    decoder = new _1.default(Buffer.from(DEFLATE_HELLO_WORLD, 'base64'), spy, false);
                    return [4, sleep(1000)];
                case 1:
                    _a.sent();
                    expect(spy).toHaveBeenCalledTimes(1);
    ...
    it("decodes binary deflated message", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    spy = jest.fn();
                    decoder = new _1.default(Buffer.from(DEFLATE_BINARY_HELLO_WORLD, 'base64'), spy, false);
                    return [4, sleep(1000)];
                case 1:
                    _a.sent();
                    expect(spy).toHaveBeenCalledTimes(1);
    ...
    it("decodes hello world json brotli message", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    spy = jest.fn();
                    decoder = new _1.default(Buffer.from(BROTLI_HELLO_WORLD, 'base64'), spy, true);
                    return [4, sleep(1000)];
                case 1:
                    _a.sent();
                    expect(spy).toHaveBeenCalledTimes(1);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect(spy).toHaveBeenCalledTimes(1);
                    expect(spy).toHaveBeenCalledWith(new Error(_1.DECODER_ERRORS.ZIP_DECOMPRESSION_ERROR), decoder);
                    return [2];
            }
        });
    }); });
